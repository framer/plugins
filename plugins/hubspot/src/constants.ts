...
export const HUBSPOT_BLOG_FIELDS: ManagedCollectionField[] = [
    ...
    {
        name: "Slug", // URL path for the blog post
        type: "string",
        id: "slug",
        userEditable: false,
    },
    ...
    {
        name: "Page Expiry Date", // Expiry date of the page
        type: "date",
        id: "pageExpiryDate",
        userEditable: false,
    },
    {
        name: "Page Expiry Redirect URL", // URL to redirect after expiry
        type: "string",
        id: "pageExpiryRedirectUrl",
        userEditable: false,
    },
]

// HubSpot is not strict on file types, so below is a list of
// all their possible file types
export const HUBSPOT_FILE_TYPES = [
    // Documents
    ".pdf",
    ".doc",
    ".docx",
