---
name: creating-framer-components
description: Generate and edit React code components for Framer, a no-code website builder. Handles property controls, animations, and accessibility. Use when creating Framer components, editing existing components, working with ControlType property controls, or building React components for Framer projects.
license: MIT
metadata:
  author: framer
  version: "1.0"
...
Generate React components for Framer with property controls, animations, and accessibility.
...
1. Generate/edit component with property controls
2. Verify: all customizable elements have controls, defaults match design
